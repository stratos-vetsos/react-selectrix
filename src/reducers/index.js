	...
	case UPDATE_INSTANCE: {
		return Object.assign( {}, state, {
			settings: Object.assign( {}, state.settings, {
				...
				inputPlaceholder: action.props.inputPlaceholder || action.props.placeholder || '',
				...
				includeTextInNotFoundPrompt: !action.props.notFoundPrompt,
				...
				disableStateVal: action.props.disableStateVal || false,
			} ),
